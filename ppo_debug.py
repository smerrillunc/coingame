...
def objective(trial):
    ...
    with mlflow.start_run():
        ...
        mlflow.log_metric("train_policy_iters", train_policy_iters)
        mlflow.log_metric("hidden_size_multiple", hidden_size_multiple)
        mlflow.log_metric("b", b)
        mlflow.log_metric("c", c)
        mlflow.log_metric("N", N)
        mlflow.log_metric("d", d)
        mlflow.log_metric("rounds", rounds)
